---
description: Convert all Python code fences in MDX files into CodeGroups with TypeScript translations
---
INSTRUCTIONS:
...
- Each Python block is translated using the agent's built-in AI capabilities
