...
After configuring your OpenAI API key, you can run this example by executing `npm llm:sample1` in the terminal. Give a try !

<iframe
  src="https://stackblitz.com/github/veigap/ai-example-wip?embed=1&file=src/hello_world.ts:L9-L17&view=editor"
  style={{ width: "100%", height: "650px", border: "0", borderRadius: "8px", overflow: "hidden" }}
  title="LLM Fundamentals StackBlitz Example"
