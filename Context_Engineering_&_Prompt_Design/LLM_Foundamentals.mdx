...
Try both approaches below. First, try the vague prompt and see how the LLM responds in prose. Then try the pattern-based approach to get structured output:
...
Now try the pattern-based approach:
