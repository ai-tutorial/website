...
description: Two-stage retrieval with cross-encoders to improve precision after fast first-pass search
...
Fast retrieval finds candidates but ranks them poorly. This page covers two-stage retrieval with cross-encoder reranking for precision optimization.
