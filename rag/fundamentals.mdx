...
<LLMPlayground
  ...
  defaultMode="chat"
  defaultInput={`What was Acme Corp's Q4 2024 revenue?`}
  response={`I don't have access to Acme Corp's internal financial data. Based on publicly available information, I cannot determine their Q4 2024 revenue. You would need to check their financial reports, SEC filings, or contact the company directly for this information.`}
  height="400px"
  keepInput={true}
/>
