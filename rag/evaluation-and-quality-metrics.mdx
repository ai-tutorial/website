---
title: Evaluation & Quality Metrics
description: How to evaluate the performance of a RAG system
sidebarTitle: Evaluation & Quality Metrics
icon: book
mode: wide
slug: rag/evaluation-and-quality-metrics
---
...
<CodeEditor
  file="src/rag/rag_evaluation.ts"
  lines="29-82"
  functionName="main"
...
<CodeEditor
  file="src/rag/rag_monitoring.ts"
  lines="66-96"
